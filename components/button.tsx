...
const Drip: React.FC<DripProps> = ({ left, height, delay }) => {
    return (
        ...
        >
            <div
                style={{ height }}
                className="w-2 rounded-b-full bg-[#c6705e] transition-colors group-hover:bg-[#a05547]"
            />
            <svg
                width="6"
                height="6"
            ...
            >
                <g clipPath="url(#clip0_1077_28)">
                    <path
                        ...
                        className="fill-[#c6705e] transition-colors group-hover:fill-[#a05547]"
                    />
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
            ...
            <motion.div
                ...
                className="absolute top-full h-2 w-2 rounded-full bg-[#c6705e] transition-colors group-hover:bg-[#a05547]"
            />
        </motion.div>
    );
};
